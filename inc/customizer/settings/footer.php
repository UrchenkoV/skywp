...
function skywp_customizer_footer_settings( $wp_customize ) {
	...
	$wp_customize->add_control( new SkyWP_Image_Radio_Button_Control( $wp_customize, 'skywp_footer_layout', array(
        ...
        'choices' => array(
			'4_25' => array(
				...
				'name' => esc_html__( 'Footer Standard', 'skywp' ),
			),
		)
	) ) );
	 ...
	 * Title Color
	 */
	$wp_customize->add_setting( 'skywp_footer_title_color', array(
		'default'				=> '#ffffff',
		'sanitize_callback' 	=> 'skywp_sanitize_color',
		'transport' 			=> 'postMessage',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'skywp_footer_title_color', array(
		'label'					=> esc_html__('Title Color', 'skywp'),
		'section'				=> 'skywp_footer_bottom',
		'settings'				=> 'skywp_footer_title_color',
		'priority'				=> 10,
	) ) );
	 ...
	 * Header Border Color
	 */
	$wp_customize->add_setting( 'skywp_footer_border_color', array(
		'default'				=> '#c7c7c7',
		'sanitize_callback' 	=> 'skywp_sanitize_color',
		'transport' 			=> 'postMessage',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'skywp_footer_border_color', array(
		'label'					=> esc_html__('Header Border Color', 'skywp'),
		'section'				=> 'skywp_footer_bottom',
		'settings'				=> 'skywp_footer_border_color',
		'priority'				=> 10,
	) ) );
	 ...
	 * Text Color
	 */
	$wp_customize->add_setting( 'skywp_footer_text_color', array(
		'default'				=> '#c7c7c7',
		'sanitize_callback' 	=> 'skywp_sanitize_color',
		'transport' 			=> 'postMessage',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'skywp_footer_text_color', array(
		'label'					=> esc_html__('Text Color', 'skywp'),
		'section'				=> 'skywp_footer_bottom',
		'settings'				=> 'skywp_footer_text_color',
		'priority'				=> 10,
	) ) );
