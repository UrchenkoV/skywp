...
class SkyWP_Pill_Checkbox_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'skywp-controls-js', SKYWP_THEME_URI . '/inc/customizer/assets/controls.js', array( 'jquery' ), SKYWP_THEME_VERSIONE, true );
