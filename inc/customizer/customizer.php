...
function skywp_custom_customize() {
	...
	wp_enqueue_style( 'skywp-customizer', SKYWP_THEME_URI .'/inc/customizer/assets/css/customizer.css', [], SKYWP_THEME_VERSIONE );
	wp_enqueue_style( 'skywp-controls-css', SKYWP_THEME_URI . '/inc/customizer/assets/controls.css', array(), SKYWP_THEME_VERSIONE );
...
function skywp_customize_preview() {
	...
	wp_enqueue_script( 'skywp-customizer', SKYWP_THEME_URI . '/inc/customizer/assets/js/customizer.js', array( 'jquery', 'customize-preview' ), SKYWP_THEME_VERSIONE, true );
...
function skywp_get_value_customize_() {
  ...
  wp_localize_script( 'skywp-main-script', 'skywp_header_sticky_value', array( 
    'skywp_header_sticky' => get_theme_mod( 'skywp_header_sticky', false ), 
  ) );

  wp_localize_script( 'skywp-main-script', 'skywp_header_position_mobile_menu', array( 
    'skywp_header_position_mobile_menu' => get_theme_mod( 'skywp_header_position_mobile_menu', 'left' ), 
  ) );

  wp_localize_script( 'skywp-main-script', 'skywp_header_opening_mobile_menu', array( 
    'skywp_header_opening_mobile_menu' => get_theme_mod( 'skywp_header_opening_mobile_menu', 'overlap' ), 
  ) );

  wp_localize_script( 'skywp-main-script', 'skywp_post_page_style', array( 
    'skywp_post_page_style' => get_theme_mod( 'skywp_post_page_style', 'default' ), 
  ) );
